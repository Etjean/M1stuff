...
# PACKAGES UTILISES
*** Le package "animation" nécessite l'installation de ImageMagick sous Windows.
```{r}
...
# SUIVI DE L'ENERGIE POTENTIELLE
```{r}
